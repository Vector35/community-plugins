...
|[bncov](https://github.com/ForAllSecure/bncov)|[Mark Griffin](https://github.com/ForAllSecure)|2021-11-03|MIT|helper|Code coverage analysis and visualization plugin|
...
|[TypeLib Exporter](https://github.com/SmoothHacker/BN-TypeLib-Exporter)|[SmoothHacker](https://github.com/SmoothHacker)|2022-10-15|MIT|binaryview, helper, ui|This plugin compiles exported functions and its corresponding types into a type library. Type libraries can also be applied to existing bndbs through this plugin.|
