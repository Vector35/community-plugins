...
|[BinSync](https://github.com/binsync/binsync)|[BinSync Team](https://github.com/binsync)|2023-04-17|BSD 2-clause|core, ui|Adds support for cross-decompiler collab in the BinSync supported decompilers.|
...
|[BNIL Instruction Graph](https://github.com/withzombies/bnil-graph)|[Ryan Stortz (@withzombies)](https://github.com/withzombies)|2023-05-13|Apache-2.0|ui|A plugin to graph BNIL instruction trees|
...
|[ClassyPP](https://github.com/CySHell/ClassyPP)|[CyShell](https://github.com/CySHell)|2023-01-11|MIT|binaryview|Parse and extract class information from MSVC x86 32\64 bit C++ binaries.|
...
|[decomp2dbg](https://github.com/mahaloz/decomp2dbg)|[Zion Basque (@mahaloz)](https://github.com/mahaloz)|2023-02-27|BSD 2-clause|core|Adds support for Binary Ninja decompilation in your debugger, curently only supports GDB|
...
|[hexfiles](https://github.com/toolCHAINZ/hexfiles)|[toolCHAINZ](https://github.com/toolCHAINZ)|2023-05-19|MIT|binaryview|A simple loader for Motorola SREC, Intel HEX, and TI-TXT files.|
...
|[keypatch](https://github.com/lwerdna/keypatch_binja)|[lwerdna](https://github.com/lwerdna)|2023-01-05|Unlicense|helper, ui|Remake of keypatch plugin for Binary Ninja|
...
|[Python bytecode](https://github.com/Njord0/BNPyc)|[Njörd](https://github.com/Njord0)|2023-04-03|MIT|architecture, binaryview|Python bytecode (.pyc) support for Binary Ninja|
