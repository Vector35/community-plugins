...
|[Golang Symbol Restore](https://github.com/d-we/binja-golang-symbol-restore)|[Daniel Weber](https://github.com/d-we)|2020-06-09|MIT|helper|Binary Ninja plugin for restoring function names from stripped Golang binaries|
...
|[VulnFanatic](https://github.com/Martyx00/VulnFanatic)|[Martin Petran](https://github.com/Martyx00)|2020-07-26|Apache-2.0|helper|Assistant plugin for vulnerability research.|
...
|[BNIL Instruction Graph](https://github.com/withzombies/bnil-graph)|[Ryan Stortz (@withzombies)](https://github.com/withzombies)|2020-07-09|Apache-2.0|ui|A plugin to graph BNIL instruction trees|
...
|[hexfiles](https://github.com/toolCHAINZ/hexfiles)|[toolCHAINZ](https://github.com/toolCHAINZ)|2020-07-26|MIT|binaryview|A simple loader for Motorola SREC, Intel HEX, and TI-TXT files.|
